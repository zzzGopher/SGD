<script lang="ts">
	...
	import LeftArrowButton from '../assets/Left-Arrow-Button.svelte';
	const size = {
		height: 32,
		width: 32
	};
...
<style>
	.Quote-Box-Parent::after {
		content: '`';
		@apply w-screen right-0 h-56 -z-10 absolute bg-primary text-primary rounded-br-3xl rounded-tr-3xl;
	}
